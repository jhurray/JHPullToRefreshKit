#
#  Be sure to run `pod spec lint JHPullToRefreshKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of JHPullToRefreshKit in Markdown format.
  ...
  # Or just: s.author    = "Jeff Hurray"
  # s.authors            = { "Jeff Hurray" => "jhurray@umich.edu" }
  # s.social_media_url   = "http://twitter.com/Jeff Hurray"
